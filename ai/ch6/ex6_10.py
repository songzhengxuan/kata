        ...
        for j in range(N):
            ...
            for e in result.edges:
                ...
                if intersect(p1, p2, e1, e2):
                    ...
                    break
            if valid:
                if line_length(p1, p2) < largest_distance:
                    largest_distance = line_length(p1, p2)
                    largest_point = p2
                    
        if largest_point != None:
            print("append edge")
            result.edges.append(p1, largest_point)
...
def main():
    ...
    draw.ellipse((100, 100)+(120,120), fill=(255,0,0))
